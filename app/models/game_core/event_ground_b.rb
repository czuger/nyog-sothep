...
#     end
    ...
    def self.table2_e2( game_board, investigator, _ )
      EEventLog.log( game_board, I18n.t( "events.#{__method__.to_s.gsub('_','.')}" ) )
      investigator.update_attribute( :weapon, true ) if investigator.loose_san( game_board, 3 )
    end

    def self.table2_e3( game_board, investigator, _ )
      EEventLog.log( game_board, I18n.t( "events.#{__method__.to_s.gsub('_','.')}" ) )
    ...
    def self.table2_e5( game_board, investigator, _ )
      EEventLog.log( game_board, I18n.t( "events.#{__method__.to_s.gsub('_','.')}" ) )
    ...
    def self.table2_e8( game_board, investigator, _ )
      EEventLog.log( game_board, I18n.t( "events.#{__method__.to_s.gsub('_','.')}" ) )
      investigator.update_attribute( :medaillon, true ) if investigator.loose_san( game_board, 2 )
    end
    ...
    #   EEventLog.log( game_board, I18n.t( "events.#{__method__.to_s.gsub('_','.')}" ) )
    #   if investigator.loose_san( game_board, 2 )
    ...
    def self.table2_e12( game_board, investigator, _ )
      EEventLog.log( game_board, I18n.t( "events.#{__method__.to_s.gsub('_','.')}" ) )
    ...
    def self.table2_e18( game_board, investigator, _ )
      EEventLog.log( game_board, I18n.t( "events.#{__method__.to_s.gsub('_','.')}" ) )

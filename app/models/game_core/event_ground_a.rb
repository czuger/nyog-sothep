module GameCore
  class EventGroundA
    ...
    def self.table1_e2( game_board, investigator, _ )
      EEventLog.log( game_board, ( I18n.t( "events.#{__method__.to_s.gsub('_','.')}" ) ) )
      investigator.update_attribute( :weapon, true ) if investigator.loose_san( game_board, 2 )
    end

    def self.table1_e3( game_board, investigator, _ )
      EEventLog.log( game_board, ( I18n.t( "events.#{__method__.to_s.gsub('_','.')}" ) ) )
    ...
    def self.table1_e6( game_board, investigator, _ )
      EEventLog.log( game_board, ( I18n.t( "events.#{__method__.to_s.gsub('_','.')}" ) ) )
      investigator.update_attribute( :spell, true ) if investigator.loose_san( game_board, 2 )
    end

    def self.table1_e7( game_board, investigator, _ )
      EEventLog.log( game_board, ( I18n.t( "events.#{__method__.to_s.gsub('_','.')}" ) ) )
    ...
    def self.table1_e11( game_board, investigator, _ )
      EEventLog.log( game_board, ( I18n.t( "events.#{__method__.to_s.gsub('_','.')}" ) ) )
      investigator.update_attribute( :weapon, true ) if investigator.loose_san( game_board, 2 )
    end

    def self.table1_e12( game_board, investigator, _ )
      EEventLog.log( game_board, ( I18n.t( "events.#{__method__.to_s.gsub('_','.')}" ) ) )
    ...
    def self.table1_e14( game_board, investigator, _ )
      EEventLog.log( game_board, ( I18n.t( "events.#{__method__.to_s.gsub('_','.')}" ) ) )
      investigator.replay!
    end
